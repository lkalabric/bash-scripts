...
[ -d "$DEMUXDIR_bm/bm1" ] && rm -r "$DEMUXDIR_bm/bm1"; mkdir -vp "$DEMUXDIR_bm/bm1"
guppy_barcoder -r -i "${BASECALLDIR}/pass" -s "${DEMUXDIR}/bm1" --arrangements_files ${ARRANGEMENTS} --trim_barcodes
pycoQC -q -f "${BASECALLDIR}/sequencing_summary.txt" -b "${DEMUXDIR}_bm/bm1/barcoding_summary.txt" -o "${RESULTSDIR}/${RUNNAME}_bm1_pycoqc.html" --report_title "${RUNNAME}_bm1" --min_pass_qual ${QSCORE} --min_pass_len ${LENGTH}

#bm2 
echo -e "\nExecutando barcoder_bm2..."
[ -d "$DEMUXDIR_bm/bm2" ] && rm -r "$DEMUXDIR_bm/bm2"; mkdir -vp "$DEMUXDIR_bm/bm2"
...
pycoQC -q -f "${BASECALLDIR}/sequencing_summary.txt" -b "${DEMUXDIR}_bm/bm2/barcoding_summary.txt" -o "${RESULTSDIR}/${RUNNAME}_bm2_pycoqc.html" --report_title "${RUNNAME}_bm2" --min_pass_qual ${QSCORE} --min_pass_len ${LENGTH}

#bm3 
echo -e "\nExecutando barcoder_bm3..."
[ -d "$DEMUXDIR_bm/bm3" ] && rm -r "$DEMUXDIR_bm/bm3"; mkdir -vp "$DEMUXDIR_bm/bm3"
...
pycoQC -q -f "${BASECALLDIR}/sequencing_summary.txt" -b "${DEMUXDIR}_bm/bm3/barcoding_summary.txt" -o "${RESULTSDIR}/${RUNNAME}_bm3_pycoqc.html" --report_title "${RUNNAME}_bm3" --min_pass_qual ${QSCORE} --min_pass_len ${LENGTH}

#bm4 
echo -e "\nExecutando barcoder_bm4..."
[ -d "$DEMUXDIR_bm/bm4" ] && rm -r "$DEMUXDIR_bm/bm4"; mkdir -vp "$DEMUXDIR_bm/bm4"
...
pycoQC -q -f "${BASECALLDIR}/sequencing_summary.txt" -b "${DEMUXDIR}_bm/bm4/barcoding_summary.txt" -o "${RESULTSDIR}/${RUNNAME}_bm4_pycoqc.html" --report_title "${RUNNAME}_bm4" --min_pass_qual ${QSCORE} --min_pass_len ${LENGTH}

#bm5
echo -e "\nExecutando barcoder_bm5..."
[ -d "$DEMUXDIR_bm/bm5" ] && rm -r "$DEMUXDIR_bm/bm5"; mkdir -vp "$DEMUXDIR_bm/bm5"
...
pycoQC -q -f "${BASECALLDIR}/sequencing_summary.txt" -b "${DEMUXDIR}_bm/bm5/barcoding_summary.txt" -o "${RESULTSDIR}/${RUNNAME}_bm5_pycoqc.html" --report_title "${RUNNAME}_bm5" --min_pass_qual ${QSCORE} --min_pass_len ${LENGTH}

#bm6 
echo -e "\nExecutando barcoder_bm6..."
[ -d "$DEMUXDIR_bm/bm6" ] && rm -r "$DEMUXDIR_bm/bm6"; mkdir -vp "$DEMUXDIR_bm/bm6"
...
pycoQC -q -f "${BASECALLDIR}/sequencing_summary.txt" -b "${DEMUXDIR}_bm/bm6/barcoding_summary.txt" -o "${RESULTSDIR}/${RUNNAME}_bm6_pycoqc.html" --report_title "${RUNNAME}_bm6" --min_pass_qual ${QSCORE} --min_pass_len ${LENGTH}
